...
namespace Model
{
  ...
  public:
     ...
     * seconds).</p> </li> </ul>
     */
    inline void SetPlayerSessionStatusFilter(const char* value) { strcpy_s(m_playerSessionStatusFilter, value); }
     ...
     * this parameter is ignored.</p>
     */
    inline void SetNextToken(const char* value) { strcpy_s(m_nextToken, value); }
