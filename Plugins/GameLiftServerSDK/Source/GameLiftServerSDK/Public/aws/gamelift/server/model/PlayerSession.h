...
namespace Model
{
  ...
  public:
     ...
     * <p>Unique identifier for a player session.</p>
     */
    inline void SetPlayerSessionId(const char* value) { strcpy_s(m_playerSessionId, value); }
     ...
     * <p>Unique identifier for a player.</p>
     */
    inline void SetPlayerId(const char* value) { strcpy_s(m_playerId, value); }
     ...
     * to.</p>
     */
    inline void SetGameSessionId(const char* value) { strcpy_s(m_gameSessionId, value); }
     ...
     * <p>Unique identifier for a fleet.</p>
     */
    inline void SetFleetId(const char* value) { strcpy_s(m_fleetId, value); }
     ...
     * location.</p>
     */
    inline void SetIpAddress(const char* value) { strcpy_s(m_ipAddress, value); }
     ...
     * <p>Custom player data.</p>
     */
    inline void SetPlayerData(const char* value) { strcpy_s(m_playerData, value); }
